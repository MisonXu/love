...
showTLab();
disp1.innerHTML = "ExoBUD MP(II) v4.1tc+ 网站媒体播放程序(liyu.net唯一简体汉化版)";
if(blnStatusBar){ window.status=('ExoBUD MP(II) v4.1tc+ 网站媒体播放程序(liyu.net唯一简体汉化版)');}
...
Exobud.close();
disp1.innerHTML = "ExoBUD MP(II) v4.1tc+ 网站媒体播放程序(liyu.net唯一简体汉化版) [就绪]";
if(blnStatusBar){ window.status=('ExoBUD MP(II) v4.1tc+ 网站媒体播放程序(liyu.net唯一简体汉化版) [就绪]');return true;}
}
...
window.open("http://www.94kb.com","vizExobud");
}
//-->
